...
public interface RuleProcessor {
    ...
    // если сообщение удовлетворяет условиям всех правил. Несколько правил объединяются в один ключ,
    // значит если несколько правил, то из них составляет один ключ и одним запросом проверяется в Redis.
